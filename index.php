...
<head>
  ...
  <title>Welcome to the Satellite Sizing Calculator</title>
...
<section class='container'>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Select your Satellite Version</h2>
                <ul>
                  <li><a href="satellite5.php">Red Hat Satellite 5.x</a></li>
                  <li><a href="satellite6.php">Red Hat Satellite 6.x</a></li>
                </ul>
